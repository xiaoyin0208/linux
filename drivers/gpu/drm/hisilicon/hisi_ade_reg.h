...
#define INTR_INIT_STATE_CPU_0_REG   (0xC00)
#define INTR_INIT_STATE_CPU_1_REG   (0xC04)
#define INTR_MASK_STATE_CPU_0_REG   (0xC08)
#define INTR_MASK_STATE_CPU_1_REG   (0xC0C)
#define INTR_MASK_CPU_0_REG         (0xC10)
#define INTR_MASK_CPU_1_REG         (0xC14)
#define INTR_CLEAR_CPU_0_REG        (0xC18)
#define INTR_CLEAR_CPU_1_REG        (0xC1C)
#define ADE_FRM_DISGARD_CTRL_REG    (0xA4)
#define ADE_SOFT_RST0_REG           (0x70)
#define ADE_SOFT_RST1_REG           (0x74)
